...
class ClientAdmin extends BaseAdmin
{
    ...
    private function addClientField(FormMapper $formMapper, ClientField $field, array $options)
    {
        switch ($field->getCode()) {
            ...
            case 'docks':
                $options['map'] = [
                    $this->getFieldOptionValueId('Да', $field) => ['additionalFielddocksYES'],
                ];
                $this->addChoiceFieldMaskTypeField($formMapper, $field, $options);
                break;
            ...
            case 'lastRegistrationPlace':
                $options['map'] = [
                    $this->getFieldOptionValueId('РФ', $field) => ['additionalFieldSubRF'],
                ];
                $this->addChoiceFieldMaskTypeField($formMapper, $field, $options);
                break;
             ...
             case 'lastRegistrationPlace':
                $options['map'] = [
                    $this->getFieldOptionValueId('Другая страна', $field) => ['additionalFieldOtherCountry'],
                ];
                $this->addChoiceFieldMaskTypeField($formMapper, $field, $options);
                break;
             ...
             case 'RodZan':
                $options['map'] = [
                    $this->getFieldOptionValueId('Другое', $field) => ['additionalFieldRodZanOther'],
                ];
                $this->addChoiceFieldMaskTypeField($formMapper, $field, $options);
                break;
             ...
             case 'Childrens':
                $options['map'] = [
                    $this->getFieldOptionValueId('Да', $field) => ['additionalFieldChildrensOther'],
                ];
                $this->addChoiceFieldMaskTypeField($formMapper, $field, $options);
                break;
             ...
             case 'Works':
                $options['map'] = [
                    $this->getFieldOptionValueId('Да', $field) => ['additionalFieldWorksMore'],
                ];
                $this->addChoiceFieldMaskTypeField($formMapper, $field, $options);
                break;
             ...
             case 'language':
                $options['map'] = [
                    $this->getFieldOptionValueId('Другой', $field) => ['additionalFieldlanguageOther'],
                ];
                $this->addChoiceFieldMaskTypeField($formMapper, $field, $options);
                break;
